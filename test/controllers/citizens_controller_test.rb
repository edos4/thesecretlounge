...
class CitizensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create citizen" do
    assert_difference('Citizen.count') do
      post citizens_url, params: { citizen: { address: @citizen.address, mobile_number: @citizen.mobile_number, name: @citizen.name } }
    end
  ...
  test "should update citizen" do
    patch citizen_url(@citizen), params: { citizen: { address: @citizen.address, mobile_number: @citizen.mobile_number, name: @citizen.name } }
